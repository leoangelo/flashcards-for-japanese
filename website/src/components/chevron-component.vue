...
<template>
  <svg v-if=expanded xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-blue-700 hover:text-blue-500 focus:text-blue-900">
  ...
  <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-blue-700 hover:text-blue-500 focus:text-blue-900">
